<?php
class JJ_Vendor_Block_Adminhtml_Vendor_Attribute_Set_Main extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Set_Main {
	...
	public function getGroupTreeJson() {
		...
		foreach ($groups as $node) {
			...
			$nodeChildren = Mage::getResourceModel('eav/entity_attribute_collection')->setEntityTypeFilter(Mage::getModel('eav/entity')->setType(JJ_Vendor_Model_Resource_Vendor::ENTITY)->getTypeId())
	...
	public function getAttributeTreeJson() {
		...
		$collection = Mage::getResourceModel('eav/entity_attribute_collection')->setEntityTypeFilter(Mage::getModel('eav/entity')->setType(JJ_Vendor_Model_Resource_Vendor::ENTITY)->getTypeId())
			->setAttributeSetFilter($setId)
			->load();
		...
		$attributes = Mage::getResourceModel('eav/entity_attribute_collection')->setEntityTypeFilter(Mage::getModel('eav/entity')->setType(JJ_Vendor_Model_Resource_Vendor::ENTITY)->getTypeId())
